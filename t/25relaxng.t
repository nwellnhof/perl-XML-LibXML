...
print "# 6 check that no_network => 1 works\n";
{
    ...
    # TEST
    like( $@, qr{Attempt to load network entity|Failed to load}, 'RNG from file location with external import and no_network => 1 throws an exception.' );
    # TEST
...
EOF
    # TEST
    like( $@, qr{Attempt to load network entity|Failed to load}, 'RNG from buffer with external import and no_network => 1 throws an exception.' );
    # TEST
